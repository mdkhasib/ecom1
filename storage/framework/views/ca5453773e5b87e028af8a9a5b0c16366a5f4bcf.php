    ...
    <div id="wrapper">
      ...
      <div class="content-page">
        ...
        <footer class="footer">
          <div class="container-fluid">
            <div class="row">
              <div class="col-md-12 text-end"><a href="https://creativedesign.com.bd" target="_blank">Website Designed by:Khairul Hasib</a></div>
            </div>
          </div>
        </footer>
        <!-- end Footer -->
...
<?php /**PATH /opt/lampp/htdocs/pro/eazytech/ecom/ecommerce1/resources/views/backEnd/layouts/master.blade.php ENDPATH**/ ?>