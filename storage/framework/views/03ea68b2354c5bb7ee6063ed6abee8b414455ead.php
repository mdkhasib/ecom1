...
<html lang="en">
    <head>
        ...
        <meta name="author" content="EazyTech Solution" />
            ...
            <div class="footer-bottom">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="copyright">
                                <p>Copyright © <?php echo e(date('Y')); ?> <?php echo e($generalsetting->name); ?>. All rights reserved | <span style="color: white;">Website Designed by: <a href="http://www.eazytechsolution.com"><span style="color: white;">EazyTech Solution</span></a></span></p>
                            </div>
                        </div>
                    </div>
                </div>
